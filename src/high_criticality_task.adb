...
with High_Criticality_Workload;
   ...
   begin
      ...
      loop
         ...
         if Iteration <= 100 and not Finished then
            ...
            --  DEBUG
            Ada.Text_IO.Put_Line (" - HI exp. " & Experiment'Image & " - ");
            ...
            if Experiment < 10 then
               ...
               Experiments_Termination.Wait_for_Termination.Set_End_Hi_Crit;
               
               Experiments_Termination.Wait_for_Printing.Set_End_Partner;
